  ...
  return (
    <View className="flex-1 bg-background px-6 py-4">
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Pressable className="bg-violet-700 w-full h-16 items-center justify-center mb-4 rounded-xl border-b-6 border-b-violet-950/40 transition-all duration-200 ease-out active:scale-[0.98] active:border-b-transparent active:translate-y-1">
